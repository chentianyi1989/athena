...
<head>
    ...
    <script src="{{ asset('/web/m3/js/jquery-2.1.3.min.js') }}" type="text/javascript"></script>
...
@include('web.m3.layouts.header')

@yield('content')
@include('web.m3.layouts.aside')
@include('web.m3.layouts.footer')
