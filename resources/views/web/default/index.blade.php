...
<div class="body" style="overflow: hidden">
    <div class="banner flexslider">
        <ul class="slides">
            <li><img src="{{ asset('/web/m7/images/xierdun/banner01.jpg') }}"/></li>
            <li><img src="{{ asset('/web/m7/images/xierdun/banner02.jpg') }}"/></li>
            <li><img src="{{ asset('/web/m7/images/xierdun/banner03.jpg') }}"/></li>
            <li><img src="{{ asset('/web/m7/images/xierdun/banner04.jpg') }}"/></li>
        </ul>
    </div>
    ...
    <div class="page-container">
        <div class="container">
            ...
            <div class="mobile-bg">
                ...
                <img class="mobile-erweima" src="{{ asset('/web/m7/images/xierdun/erweima.png') }}" alt="">
            </div>
        </div>
    </div>
</div>
