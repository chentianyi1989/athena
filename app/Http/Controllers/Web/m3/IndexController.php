...
namespace App\Http\Controllers\Web\m3;
...
class IndexController extends Controller
{
    ...
    public function index() {
        ...
        return view('web.m3.index', compact('system_notices', 'game_list'));
    }
    
    public function liveCasino() {
        $system_notices = SystemNotice::where('on_line', 0)->orderBy('sort', 'asc')->orderBy('created_at', 'desc')->get();
        return view('web.m3.liveCasino', compact('system_notices'));
    }
    
    public function lottory()
    {
        $system_notices = SystemNotice::where('on_line', 0)->orderBy('sort', 'asc')->orderBy('created_at', 'desc')->get();
        return view('web.m3.lottory', compact('system_notices'));
    }
    
    public function egame() {
        $system_notices = SystemNotice::where('on_line', 0)->orderBy('sort', 'asc')->orderBy('created_at', 'desc')->get();
        $game_list = GameList::all();
        return view('web.m3.egame', compact('system_notices','game_list'));
    }
    
    public function catchFish() {
        return view('web.m3.catchFish');
    }
    
    public function esports() {
        $system_notices = SystemNotice::where('on_line', 0)->orderBy('sort', 'asc')->orderBy('created_at', 'desc')->get();
        return view('web.m3.esports', compact('system_notices'));
    }
